...
export const Articles = ({ editing, commenting, img, text, author, date, comments, _id, 
    ...
    return (<div id="article" className="singleArticle">
        ...
        <p>
            {
                editing.indexOf(_id) < 0 ? <button onClick={_beginEdit}>Edit</button> 
            ...
            <br/>
            {
                ...
                : <input type="text" classname="articleEdits" placeholder="Your edited article here" ref={(node) => newEdit = node} />
            }
            {
                editing.indexOf(_id) < 0 ? <br/> 
                : <button className="editArticle" onClick={_edit}>Edit Post</button>
            }
            <br/>
            {
...
Articles.propTypes = {
    editing: PropTypes.arrayOf(PropTypes.number.isRequired).isRequired,
    commenting: PropTypes.arrayOf(PropTypes.number.isRequired).isRequired,
